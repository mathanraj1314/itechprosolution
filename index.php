...
if (isset($_POST['submit'])) {
	...
	$email_body = 'Name: ' . $name . ' has written you : ' . $message;
	$headers = 'From: ' . $email;

	$secretKey = "6Lc0sTUeAAAAAOy0rte9AG1Z15PXKUYG3nPaYHY2";
...
<body>
				...
				<div class="col-lg-8 d-block">
					<div class="row d-flex">
						<div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
							...
							<div class="text">
								<span>Email</span>
								<span>info@itechprosolutions.in</span>
							</div>
						</div>
						<div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
							...
							<div class="text">
								<span>Call</span>
								<span>Call Us: +91 9790176891</span>
							</div>
						</div>
						<div class="col-md topper d-flex align-items-center justify-content-end">
							<p class="mb-0 d-block">
								<a href="#quote" class="btn py-2 px-3 btn-primary">
				...
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							...
							<a class="dropdown-item" href="#">Billing Software</a>
							<a class="dropdown-item" href="#">Android App Development</a>
							<a class="dropdown-item" href="#">SEO Services</a>
							<a class="dropdown-item" href="#">Bulk IEEE Project</a>
							<a class="dropdown-item" href="#">Research & Development</a>
							<a class="dropdown-item" href="#">Paper Publication</a>

						</div>
					</li>
					<li class="nav-item"><a href="project.html" class="nav-link">IEEE Projects</a></li>
					<li class="nav-item"><a href="blog.html" class="nav-link">Final Year Projects</a></li>
			...
			<div class="row d-flex">
				<div class="col-md-5 order-md-last wrap-about align-items-stretch">
					<div class="wrap-about-border ftco-animate">
						...
						<div class="text">
							<h3>About Us</h3>
							<p>iTechpro Solutions is a Pondicherry based company started on 2013 and within short period of time span it has grown up into a well developed project center handling more number of projects for any type of universities. We started with doing IEEE projects for final year students and jumping into guiding the projects for PHD candidates. <br> <a href="about.html"><i>Read More>></i></a></p>
			...
			<div class="row no-gutters">
				<div class="col-lg-4 d-flex">
					<div class="services-2 noborder-left text-center ftco-animate">
						<div class="icon mt-2 d-flex justify-content-center align-items-center"><span><i class="fab fa-python"></i></span></div>
						<div class="text media-body">
							<h3>Python</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia.</p>
						</div>
				...
				<div class="col-lg-4 d-flex">
					<div class="services-2 text-center ftco-animate">
						<div class="icon mt-2 d-flex justify-content-center align-items-center"><span><i class="fab fa-android"></i></span></div>
						<div class="text media-body">
							<h3>Android App</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia.</p>
						</div>
		...
		<div class="container">
			<div class="row justify-content-center">
				...
				<div class="col-lg-3 col-md-4 ftco-animate">
					<p class="mb-0"><a href="#quote" class="btn btn-white py-3 px-4">Request Quote</a></p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="ftco-section ftco-consult ftco-no-pt ftco-no-pb" id="quote" style="background-image: url(images/bg_5.jpg);" data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="container">
			<div class="row justify-content-end">
				<div class="col-md-6 py-5 px-md-5">
					<div class="py-md-5">
						...
						<form action="<?= $_SERVER['PHP_SELF'] ?>" method="post" class="appointment-form ftco-animate">
							<div class="d-md-flex">
							...
							<!-- <div class="d-md-flex"> -->
								...
								<div class="form-group">
									<div class="g-recaptcha" data-sitekey="6Lc0sTUeAAAAAGnJJuMD7n3Mlc58OsGpf0Z3H0BN">
									</div>
								</div>
								<div class="form-group ml-md-4">
			...
			<div class="row">
				<div class="col-md-6 col-lg-4 ftco-animate">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('images/python.jpg');"></a>
				...
				<div class="col-md-6 col-lg-4 ftco-animate">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('images/phpjava.jpg');"></a>
						<div class="text bg-white p-4">
							<h3 class="heading"><a href="#">PHP & Java</a></h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							<div class="d-flex align-items-center mt-4">
								<p class="mb-0"><a href="#" class="btn btn-primary">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
								<p class="ml-auto mb-0">
				...
				<div class="col-md-6 col-lg-4 ftco-animate">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('images/ai.jpg');"></a>
						<div class="text bg-white p-4">
							<h3 class="heading"><a href="#">AI</a></h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							<div class="d-flex align-items-center mt-4">
								<p class="mb-0"><a href="#" class="btn btn-primary">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
								<p class="ml-auto mb-0">
				...
				<div class="col-md-6 col-lg-4 ftco-animate">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('images/embeddediot.jpg');"></a>
						<div class="text bg-white p-4">
							<h3 class="heading"><a href="#">Embedded & IOT</a></h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							<div class="d-flex align-items-center mt-4">
								<p class="mb-0"><a href="#" class="btn btn-primary">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
								<p class="ml-auto mb-0">
				...
				<div class="col-md-6 col-lg-4 ftco-animate">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('images/ml.jpg');"></a>
						<div class="text bg-white p-4">
							<h3 class="heading"><a href="#">Machine Learning</a></h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							<div class="d-flex align-items-center mt-4">
								<p class="mb-0"><a href="#" class="btn btn-primary">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
								<p class="ml-auto mb-0">
				...
				<div class="col-md-6 col-lg-4 ftco-animate">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('images/robotics.jpg');"></a>
						<div class="text bg-white p-4">
				...
				<div class="col-md-6 col-lg-3">
					<div class="ftco-footer-widget mb-5">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-map-marker"></span><span class="text">260, Maraimalai Adigal Salai,(Near new bus stand) Puducherry, 605013.</span></li>
								<li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 9790176891</span></a></li>
								<li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@itechprosolutions.in</span></a></li>
							</ul>
						</div>
					</div>
				</div>
